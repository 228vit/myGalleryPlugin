 ...
 */
class BaseGalleryAdminComponents extends sfComponents
{
  ...
  public function executeEdit(sfWebRequest $request)
  {
    ...
    if ($this->hasGallery = $this->object->hasGallery())
    {
      ...
      // News -> news, ProductGallery -> product_gallery
      $this->model_name = sfInflector::underscore(get_class($this->object));
    }
