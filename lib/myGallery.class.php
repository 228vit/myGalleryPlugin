...
class myGallery
{
  ...
  {
      if( sfConfig::get( 'app_myGalleryPlugin_restricted' ) )
      {
          return myGallery::isUserBoundAndAuthenticated($user);
      }
      else
      {
          return true;
  ...
  {
    return sfConfig::get('app_myGalleryPlugin_pagination_active', false);
  }
  ...
  static function getMaxPerPage(Doctrine_Query $query)
  {
    ...
    {
      return sfConfig::get('app_myGalleryPlugin_max_per_page', 10);
    }
  ...
  {
    return sfConfig::get('app_myGalleryPlugin_list_order', 'ASC');
  }
  ...
  {
    return sfConfig::has('app_myGalleryPlugin_profile');
  }
  ...
  {
    return sfConfig::get( 'app_myGalleryPlugin_guardbind', false );
  }
  ...
  static function getProfileInformation($key)
  {
    ...
    $informations = sfConfig::get('app_myGalleryPlugin_profile');
