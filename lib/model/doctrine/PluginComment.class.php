...
abstract class PluginComment extends BaseComment
{
    public function getAuthor()
    {
      if($this->isGuardBindAndUserId())
      {
        if(
          ...
          ($field = myGallery::getProfileInformation('field_name')) !== false
        )
        {
    ...
    public function getEmail()
    {
      if($this->isGuardBindAndUserId())
      {
        if(
          ($profile = $this->getProfileAlias()) !== false &&
          ($field = myGallery::getProfileInformation('field_email')) !== false
        )
        {
          return $profile->{'get'.$field}();
        }
    ...
    public function getWebsite()
    {
      if($this->isGuardBindAndUserId())
      {
        if(
          ($profile = $this->getProfileAlias()) !== false &&
          ($field = myGallery::getProfileInformation('field_website')) !== false
        )
        {
          return $profile->{'get'.$field}();
        }
    ...
    {
      if(($alias = myGallery::getProfileInformation('alias')))
      {
