...
class PluginCommentCommonForm extends BaseCommentForm
{
  public function setup()
  {
    ...
    $this->required     = __('Required', array(), 'myGallery');
    $this->invalid_mail = __('Invalid Mail', array(), 'myGallery');
    $this->invalid_url  = __('Invalid Url', array(), 'myGallery');
    $this->required_msg = __('Required message', array(), 'myGallery');
    ...
    $this->widgetSchema->setLabel('author_name', __('Name', array(), 'myGallery'));
    $this->widgetSchema->setLabel('author_email', 'Email');
    $this->widgetSchema->setLabel('author_website', __('Website', array(), 'myGallery'));
    $this->widgetSchema->setLabel('body', 'Message');
    $this->widgetSchema->setHelp('author_website', __('Must start with http:// or https://', array(), 'myGallery'));
  ...
  protected function doUpdateObject($values)
  {
    ...
    $purifier = new myGalleryPurifier();
