...
abstract class PluginCommentReportForm extends BaseCommentReportForm
{
  public function setup()
  {
    ...
    $this->widgetSchema
            ->setLabel('reason', __('Reason', array(), 'myGallery'))
            ->setHelp('reason', __('Why this message should be moderated ?', array(), 'myGallery'));
    $this->validatorSchema['reason']
            ->setMessage('required', __('Required', array(), 'myGallery'));
